...
RUN R -e "install.packages(c('Biostrings', 'data.table', 'dplyr','ggplot2', 'GenomicRanges', 'IRanges', 'Matrix', 'matrixStats', 'pbmcapply', 'Rsamtools', 'Rsubread', 'S4Vectors', 'utils', 'BiocManager'), repos='https://cloud.r-project.org/')"
